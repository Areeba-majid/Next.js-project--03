  ...
  return (
    ...
    />
          ...
          <div className="bg-white p-6 shadow-lg">
            ...
            <h3 className="text-xl font-semibold mb-2">Gol Gappy</h3>
            <p>PKR : 250</p>
          </div>
          ...
          <div className="bg-white p-6 shadow-lg">
            ...
            <h3 className="text-xl font-semibold mb-2">Masala Chai</h3>
            <p>PKR : 90</p>
          </div>
          ...
          <div className="bg-white p-6 shadow-lg">
            ...
            <h3 className="text-xl font-semibold mb-2">Juices</h3>
            <p>PKR : 200</p>
          </div>
